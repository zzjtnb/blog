...
description: 'VS Code 插件 Beautify 和 Vetur 中的 jsbeautifyhtml 配置项 简介 Beautify 是格式化代码的插件 可美化 JS.JSON.CSS.Sass.HTML其他类型的文件不行 配置规则 1. 适合所有文'
date: '2021-11-25 14:48:50'
updated: ''
category: 'VS Code'
tags:
  - 'Vue'
...
hot: false
sourceId: 266
sourcePath: 'vscodecjbeautifyhveturzdjsbeautifyhtmlpzx'
---
