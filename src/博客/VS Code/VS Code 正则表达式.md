---
title: 'VS Code 正则表达式'
description: '代码注释 js 在 Visual Studio Code 中使用正则表达式来匹配单行和多行注释, 同时避免匹配到 URL, 可以使用以下正则表达式示例: 单行注释 这个正则表达式使用了负向前瞻 Negative Lookahead, 以确保'
date: '2023-11-29 15:05:53'
updated: '2023-11-29 15:06:47'
category: 'VS Code'
tags:
  - 'VS Code'
  - '正则表达式'
...
[正则大全|支持web / vscode / idea / Alfred Workflow多平台](https://any-rule.vercel.app/)
