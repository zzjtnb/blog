...
description: 'VS Code 导出或导入用户配置脚本 Windows 用户推荐使用 Git Bash 检查 code 命令是否可用 对于 Windows 用户，如果 Code 命令不可用 在系统环境变量Path添加VS Code完整安装路径\bin. 例'
date: '2023-12-01 16:13:45'
updated: '2023-12-01 16:24:42'
category: 'VS Code'
tags:
  - 'VS Code'
