...
description: 'EclipseLDT官方汉化和插件安装 打开下面网址 复制下载地址 打开编辑器 1.点击HelpInstall New Software后会跳出弹窗 2.Work with后面的Add输入 3.点击下方的Add会关闭窗口搜索语言包,等待搜索'
date: '2021-03-27 13:54:57'
updated: '2021-03-27 14:13:46'
category: '后端'
tags:
  - '编辑器'
  - '汉化'
...
hot: false
sourceId: 226
sourcePath: 'eclipseldtgfhhhcjaz'
---
# Eclipse(LDT)官方汉化和插件安装
## 打开下面网址
```bash
