...
description: 'javadoc d javaApi Doc.java 如果.java文件是utf8格式的话加参数 encoding utf8 javadoc encoding utf8 d javaApi Doc.java 或者输出作者和版本信息 java'
date: '2020-04-05 07:30:17'
updated: ''
category: '后端'
tags:
  - 'Java'
...
hot: false
sourceId: 127
sourcePath: 'javayjavadocdqzsxx'
---
`javadoc -d javaApi Doc.java`

如果.java文件是utf-8格式的话加参数 -encoding utf-8
