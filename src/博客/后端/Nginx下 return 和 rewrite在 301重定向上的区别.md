...
description: '唯一区别：正则匹配的性能区别 第一种 rewrite 写法是抓取所有的 URI 再减去开头第一个 / 反斜线。 第二种写法用了$requesturi 省去了减去开头第一个反斜线的过程，正则匹配上性能更优。但仍不如第三种写法，因为 rewri'
date: '2020-04-05 23:47:34'
updated: ''
category: '后端'
tags:
  - 'Nginx'
...
hot: false
sourceId: 133
sourcePath: 'nginxxreturnhrewritez301zdxsdob'
---
唯一区别：正则匹配的性能区别
