...
description: '在 nginx.conf 中通过 假如查找的位置在/etc/nginx/nginx.conf就在nginx.conf的 http 块下加一句include conf.d/.conf;就可以了 编辑 nginx.conf 完整示例 然后我们只'
date: '2020-04-08 14:55:01'
updated: '2022-09-23 03:30:56'
category: '后端'
tags:
  - 'Nginx'
