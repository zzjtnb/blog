...
description: '先说结论： 如果是个人网站，或网站用途只是开发测试，改动的可能性比较大，建议使用302 如果是生产环境，或改动的可能性比较小，建议使用301 状态码含义 "状态码含义"状态码含义 首先要明白两个状态码的含义： 301 Moved Perma'
date: '2020-04-05 23:54:33'
updated: ''
category: '后端'
tags:
  - 'Nginx'
