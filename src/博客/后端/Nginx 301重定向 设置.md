...
description: '在 nginx 中配置，使得访问不带 www 的网址自动重定向到带 www 的域名。 http 协议的重定向 在 nginx 官方文档https://link.jianshu.com/?t=http://nginx.org/en/docs/'
date: '2020-04-05 23:56:33'
updated: ''
category: '后端'
tags:
  - 'Nginx'
