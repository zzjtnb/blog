---
title: 'nginx配置环境变量'
description: '一、先找到nginx的安装地址 二、在/etc/profile 中加入配置 打开配置文件 在配置文件末尾加入 ==/usr/local/nginx1.10.2是你输入whereis nginx后系统输出的路径,按照实际情况填写== 编辑完保'
date: '2020-04-05 17:33:20'
updated: ''
category: '后端'
tags:
  - 'Nginx'
