...
description: '做为一个有情怀的 Coder，最近收集了一下 JavaScript 代码注释范例，希望能够帮助大家撸得一手妖媚而又放荡的 Bug。 普通注释 单行注释 使用 // 作为单行注释。 单行注释符后与注释内容保留一个空格。 单行注释需要在说明的代'
date: '2020-05-21 22:47:24'
updated: '2020-12-08 22:31:24'
category: '技术资料'
tags:
  - 'JavaScript'
...
_Google Closure Compiler 可选参数_
