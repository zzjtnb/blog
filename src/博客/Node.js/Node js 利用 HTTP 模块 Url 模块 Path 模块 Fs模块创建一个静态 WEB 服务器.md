...
description: '利用 HTTP 模块 Url 模块 Path 模块 Fs模块创建一个静态 WEB 服务器 目录 1 、Node.js 创建的第一个应用 2 、WEB服务器介绍 3 、Nodejs创建一个WEB服务器。 1 、 Node.js 创建的第一个应'
date: '2020-06-05 17:16:03'
updated: '2021-05-27 20:15:20'
category: 'Node.js'
tags:
  - 'Node.js'
  - 'URL'
...
hot: false
sourceId: 164
sourcePath: 'nodejslyhttpmkurlmkpathmkfsmkcjygjtwebfwq'
---
