...
description: 'Node.js 是一个用于通用编程的 JavaScript 平台，允许用户快速构建异步网络应用程序。通过在前端和后端利用 JavaScript，Node.js 可以使 Web 应用程序开发更加一致...... 介绍 Node.jshttps'
date: '2021-03-03 19:53:32'
updated: '2021-05-27 20:13:25'
category: 'Node.js'
tags:
  - 'Node.js'
...
本指南假设您使用的是 Debian 10. 在开始之前，您应该让非 root 用户在您的系统上设置 sudo 权限。 您可以通过遵循 Debian 10教程的初始服务器设置来学习如何设置它。
