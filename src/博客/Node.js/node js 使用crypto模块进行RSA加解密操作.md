...
description: '多余的话不说了，直接上代码 先在 package.json 配置文件里添加 crypto 模块的支持。 加密工具类： 注：公钥，私钥怎么生成这里不介绍了，网上很多。 生成后保存成 pem 文件，放到工程目录下引用即可 使用： 完。'
date: '2020-12-29 14:04:31'
updated: '2021-05-27 20:11:44'
category: 'Node.js'
tags:
  - 'Node.js'
...
hot: false
sourceId: 212
sourcePath: 'nodejssycryptomkjxrsajjmcz'
---
多余的话不说了，直接上代码
