...
description: '查询指定日期某列相同字段之和大于某值 对应sql 查询指定日期某列相同字段某个字段之和 对应sql 批量更新,重复则替换 批量创建,重复则失败 mysql禁止指定字段相关的重复解决方案设置相关字段的索引,字段填写不允许重复的字段,索引类型选'
date: '2021-01-22 19:41:55'
updated: '2021-05-27 20:11:53'
category: 'Node.js'
tags:
  - 'Sequelize'
  - 'MySQL'
...
hot: false
sourceId: 218
sourcePath: 'sequelizedydmysqlczzdrqqhplcjplgx'
---
查询指定日期某列相同字段之和大于某值
```js
...
mysql禁止指定字段相关的重复解决方案-->设置相关字段的索引,字段填写不允许重复的字段,索引类型选择UNIQUE,索引方法选择BTREE
