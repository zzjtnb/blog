...
description: 'nvm 用于管理多个node版本的工具. Windows 下载安装与使用 1. 点击 下载地址https://github.com/coreybutler/nvmwindows/releases 进入 nvm 下载页面; 2. 选择最新版本'
date: '2021-05-06 02:00:05'
updated: '2022-10-21 10:39:05'
category: 'Node.js'
tags:
  - 'NVM'
...
hot: false
sourceId: 240
sourcePath: 'nvmazhpznpmyarnpnpm'
---
...
`nvm exec [--silent]  []`|使用指定的 版本运行 command 命令|
|`nvm run [--silent]  []`|使用指定的版本运行 args ||`nvm alias`|  对 version 版本设置一个别名|
|`nvm unalias`| 删除这个别名|
...
|`nvm uninsstall [version]`|卸载指定版本 node|
