...
description: 'JavaScript把空字符串转null JavaScript把'''' ,'' ''这种空字符串转成null 1.str2null.js 2.router.js'
date: '2020-12-26 01:54:08'
updated: '2021-05-27 20:12:17'
category: 'Node.js'
tags:
  - 'Node.js'
...
hot: false
sourceId: 211
sourcePath: 'javascriptbkzfcznull'
---
# JavaScript把空字符串转null
JavaScript把'' ,'  '这种空字符串转成null
## 1.str2null.js
```js
/**
 * null => ''
