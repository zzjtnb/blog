...
description: '举例 format http://nodejs.cn/s/9Tw2bK 一个类似 printf 的格式字符串。 util.format 方法返回一个格式化后的字符串，使用第一个参数作为一个类似 printf 的格式的字符串，该字符串可以包含'
date: '2020-06-02 20:51:18'
updated: '2021-05-27 20:16:45'
category: 'Node.js'
tags:
  - '占位符'
