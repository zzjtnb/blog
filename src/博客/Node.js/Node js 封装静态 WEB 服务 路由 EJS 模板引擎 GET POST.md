...
description: 'NodeJs 封装静态 WEB 服务、 路由、EJS 模板引擎、 GET 、 POST 目录 1 、Nodejs 静态文件托管 2 、路由 3 、初识EJS模块引擎 4 、Get、Post 1 、 Nodejs 封装静态 web 服务 se'
date: '2020-06-05 17:17:01'
updated: '2021-05-27 20:15:01'
category: 'Node.js'
tags:
  - 'Node.js'
...
hot: false
sourceId: 165
sourcePath: 'nodejsfzjtwebfwlyejsmbyqgetpost'
---
