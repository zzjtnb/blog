...
description: 'npm 包的更新速度之快想必大家都了然于心，那么新版本发布后，怎样将依赖包更新到最新版本呢？ 背景：独立维护项目的架构与开发工作，在升级依赖包时发现使用 yarn upgrade 更新依赖包，yarn.lock 文件更新了，但是 packa'
date: '2021-07-28 12:43:12'
updated: '2021-07-28 12:57:04'
category: 'Node.js'
tags:
  - 'yarn'
  - 'npm'
