---
title: '封装Fetch请求'
description: '默认 语法 input 定义要获取的资源. 这可能是: 一个 USVString 字符串, 包含要获取资源的 URL. 一些浏览器会接受 blob: 和 data: 作为 schemes. 一个 Request 对象. init 可选 一个'
date: '2023-11-29 12:26:28'
updated: '2023-11-29 22:15:05'
category: '前端'
tags:
  - 'Fetch'
