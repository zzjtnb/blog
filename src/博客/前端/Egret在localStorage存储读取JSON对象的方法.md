...
description: '一、存储数据 数据obj 通过上面的方法，localStorage中储存的数据为下面的数据 二、读取数据 读取对象的某个属性 三、移除数据 四、清除所有数据'
date: '2019-04-22 15:46:34'
updated: ''
category: '前端'
tags:
  - 'Egret'
...
hot: false
sourceId: 61
sourcePath: 'egretzlocalstorageccdqjsondxdff'
---
# 一、存储数据
## 数据obj
```json
