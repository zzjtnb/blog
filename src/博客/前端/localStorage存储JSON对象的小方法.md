...
description: '有时候, 我们需要将数据存储到 sessionStorage 和 localStorage 中, 这样做的好处有: 1 缓存数据 2 减少对内存的占用 但是, storage 只能存储字符串的数据, 对于 JS 中常用的数组或对象却不能直接'
date: '2019-04-22 15:12:33'
updated: ''
category: '前端'
tags:
  - 'localStorage'
...
hot: false
sourceId: 60
sourcePath: 'localstorageccjsondxdxff'
---
