...
description: '关于 Math.floor 与 parseInt 它们两个都是只保留整数部分，但是在转换时可能会出现不精确的情况： 临界点： 当有 16 位小数，且最后一位小数为 5 时，取的值是该数值的最大整数； Math.floor5.99999999'
date: '2019-12-05 14:50:57'
updated: ''
category: '前端'
tags:
  - 'JavaScript'
