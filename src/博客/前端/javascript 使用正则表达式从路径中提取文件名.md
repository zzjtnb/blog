...
description: '如何使用正则表达式从下面的URL中提取字符串“ XMLFileName” 可以使用split，pop和replace ... jsbinhttps://jsfiddle.net/h8uK6 也可以使用单个正则表达式 jsbinhttp://'
date: '2020-08-12 00:57:09'
updated: ''
category: '前端'
tags:
  - '正则'
...
hot: false
sourceId: 181
sourcePath: 'javascriptsyzzbdscljzdqwjm'
---
