---
title: 'css 跳动文字'
description: '@keyframes使用说明 使用@keyframes规则，创建动画。 创建动画是通过逐步改变从一个CSS样式设定到另一个。 在动画过程中，可多次更改CSS样式的设定。 指定的变化时发生时使用％，或关键字”from”和”to”，这是和0％到'
date: '2020-04-10 12:25:11'
updated: ''
category: '前端'
tags:
  - 'CSS'
