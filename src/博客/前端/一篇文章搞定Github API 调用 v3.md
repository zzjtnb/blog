...
description: '对于常用 Github 的用户来说，经常有一些自动化的需求。比如我的需求是定时备份 Github 的 issues 和 comments 到本地。以下为 Github 的 API 的使用参考。 v3 版 API 的文档链接https://d'
date: '2019-11-26 21:07:03'
updated: ''
category: '前端'
tags:
  - 'GitHub'
...
hot: false
sourceId: 105
sourcePath: 'ypwzgdgithubapidyv3'
---
...
![](https://segmentfault.com/img/remote/1460000015144131)
...
![](https://segmentfault.com/img/remote/1460000015144132)
...
JSON 填写如下图：  
![](https://segmentfault.com/img/remote/1460000015144135)
...
![](https://segmentfault.com/img/remote/1460000015144136)  
原来，我的 token 看似是正常的，唯独错误的是，多了一个空行！也就是说，标明都是 invalid JSON，结果没注意竟然是 invalid Token!

增加文件成功后返回的消息：  
![](https://segmentfault.com/img/remote/1460000015144137)
...
![](https://segmentfault.com/img/remote/1460000015144138)

或者如果用错了 SHA，会出现 409 错误消息：  
![](https://segmentfault.com/img/remote/1460000015144139)

如果正确传送，就会显示 200 完成更新：  
![](https://segmentfault.com/img/remote/1460000015144140)
...
删除成功后，会返回 200 消息：  
![](https://segmentfault.com/img/remote/1460000015144141)
...
不允许别人评论（自己可以）  
![](https://segmentfault.com/img/remote/1460000015144142)
