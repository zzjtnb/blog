...
title: '常用CSS基本指南'
description: ''
date: '2018-06-17 10:39:41'
updated: '2022-03-01 01:00:58'
category: '前端'
tags:
  - 'CSS'
cover: 'https://cdn.pixabay.com/photo/2018/08/23/07/35/thunderstorm-3625405_960_720.jpg'
hot: false
sourceId: 8
sourcePath: 'cycssjbzn'
---
```css
1. CSS基本属性
字体属性：(font)
...
4 边框颜色 {border-color:数值 数值 数值 数值}   数值（含义）：分别代表top、right、bottom、left颜色值
