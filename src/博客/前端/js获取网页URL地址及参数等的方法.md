...
description: '先看一个示例 用javascript获取url网址信息 执行 用javascript获取url网址信息 代码效果如下 详细介绍 window.location方法获取URL 示例：'
date: '2018-11-27 10:41:20'
updated: ''
category: '前端'
tags:
  - 'JavaScript'
