...
description: '在 CSS flexbox 布局出现以前，如果要控制 HTML 元素的布局，要用到很多种奇葩的方式。在水平方向上得用float控制左右对齐，稍一不注意，就会有浮动的元素飞来飞去~。在垂直方向上就更是百家争鸣了：要么手动计算高度然后算出中心点'
date: '2020-04-13 18:49:40'
updated: ''
category: '前端'
tags:
  - 'CSS'
...
hot: false
sourceId: 145
sourcePath: 'cssflexboxbjjc2020zxb'
---
...
![](https://raw.githubusercontent.com/zzjtnb/images/master/test/Alignment.png)
...
![](https://raw.githubusercontent.com/zzjtnb/images/master/test/Arrangement.png)
