---
title: 'Dart 库教程'
description: 'Dart 库教程 Dart 官网https://www.dartlang.org/guides/libraries/librarytour。 当前版本：2.2.0 stable 该教程为你展示了下面这些库的主要特性，这些库被包含在所有的 D'
date: '2022-02-28 06:46:49'
updated: '2022-10-16 20:46:45'
category: '前端'
tags:
  - 'Dart'
cover: 'https://raw.githubusercontent.com/zzjtnb/static/master/images/test/dart-teaser.png'
hot: false
sourceId: 271
sourcePath: 'dartkjc'
---
...
[Dart 官网](https://www.dartlang.org/guides/libraries/library-tour)。
...
使用 **trim()** 移除前面和后面的所有空白。要检查一个字符串是否是空的（长度为 0），使用 **isEmpty**。
...
一个日期的 **millisecondsSinceEpoch** 属性返回距“Unix 纪元”——UTC 时间 1970 年 1 月 1 日 ——的毫秒数：
...
要了解更多关于 Dart 语言的内容，请参阅 [语言教程](https://zzjtnb.com/blog/details/dartrmjc)。
