...
description: '配置 以下是一个示例的 Chrome 调试配置文件 launch.json 的内容: 在这个配置文件中, 有几个关键的选项: 1. "name": 配置的名称, 用于在 VS Code 中标识该配置. 2. "type": 调试器的类型.'
date: '2023-07-09 19:11:52'
updated: '2023-07-09 19:12:23'
category: '前端'
tags:
  - 'VS Code'
