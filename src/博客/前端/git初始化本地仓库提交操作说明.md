...
description: 'git关联仓库、拉取代码、提交代码完整流程 ==== 1. 本地项目上传到github上指定项目地址 在项目里面打开点击右键 2. 通过命令把这个目录变成git可以管理的仓库: 3. 关联到远程库, 这里的远程仓库选择Clone with'
date: '2018-06-12 15:34:33'
updated: '2022-03-01 01:27:11'
category: '前端'
tags:
  - 'Git'
