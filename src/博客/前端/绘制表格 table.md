---
title: '绘制表格-table'
description: '之前做页面都没有画表格的经历, 最近工作中有接触到, 刚好补了一下这方面的知识 结构 一个较完整的表格结构如下 caption 是表格的标题 thead 里放的是表格的头, 一个头对应一个 th tbody 里放的是表格的数据, 一条数据对'
date: '2019-07-02 14:00:02'
updated: ''
category: '前端'
tags:
  - 'HTML'
