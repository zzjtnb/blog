---
title: '普通函数与箭头函数的区别'
description: '箭头函数是 ES6 的 API，相信很多人都知道，因为其语法上相对于普通函数更简洁，深受大家的喜爱。就是这种我们日常开发中一直在使用的 API，大部分同学却对它的了解程度还是不够深... 普通函数和箭头函数的区别： 箭头函数的 this 指'
date: '2019-04-15 16:54:14'
updated: ''
category: '前端'
tags:
  - 'JavaScript'
