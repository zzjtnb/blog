...
description: 'Plyr 是一个简单的可定制的 HTML5 媒体播放器，使用原生 JavaScript 没有其他依赖。支持 YouTube 和 Vimeo 。 特色 无障碍 – 完全支持 VTT 字幕和屏幕阅读器 轻量级 – 压缩后小于 10 KB 可定制'
date: '2020-09-18 19:12:19'
updated: ''
category: '前端'
tags:
  - 'JavaScript'
