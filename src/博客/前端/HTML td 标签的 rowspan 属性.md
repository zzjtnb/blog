...
description: '代码 rowspan 属性规定单元格可横跨的行数。 浏览器支持 所以浏览器都支持 rowspan 属性。 没有浏览器支持 rowspan="0"，这个值有特殊的意义。（参见属性值表格中的描述） 语法 属性值 | 值 | 描述 | | | :'
date: '2018-10-18 18:18:44'
updated: ''
category: '前端'
tags:
  - 'HTML'
