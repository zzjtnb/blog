---
title: 'CSS实现响应式全屏背景图'
description: '当前很流行的一种网页形式就是满屏大图，本文将用最简单的方式实现该效果。用到了 CSS 属性 backgroundsize , 无需 javascript。 先看 demohttp://cdn.sixrevisions.com/043101r'
date: '2018-07-20 11:47:17'
updated: '2022-03-01 01:00:34'
category: '前端'
tags:
  - 'CSS'
