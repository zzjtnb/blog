---
title: '聊聊移动端的REM适配问题'
description: '现在移动端对于前端行业来说特别流行, 废话不多说, 那我们就来聊聊移动端的哪些事? 注意: 写移动端必须在 html 页面 head 标签内加一个 meta 标签 viewport 视口 1. 来简单说说 rem 原理：rem=root e'
date: '2018-11-27 15:34:44'
updated: ''
category: '前端'
tags:
  - 'CSS'
