---
title: '浏览器的三个储存'
description: 'cookie、localStorage 和 sessionStorage 的使用以及区别 localStorage 和 sessionStorage 的增删改查： 1. 存储数据： 2. 获取指定键名数据： 3. 获取 sessionSto'
date: '2019-05-27 15:43:55'
updated: ''
category: '前端'
tags:
  - 'JavaScript'
