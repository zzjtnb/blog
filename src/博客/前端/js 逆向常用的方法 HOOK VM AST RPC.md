...
description: 'JS 逆向常用 HOOK 代码 JSON HOOK COOKIE HOOK Search Decode Hook Headers Hook Debugger Hook eval Hook VM Node.js 的 vm 模块是一个内置模块,'
date: '2023-11-29 12:38:13'
updated: ''
category: '前端'
tags:
  - 'JavaScript'
...
hot: false
sourceId: 295
sourcePath: 'jsnxcydffhookvmastrpc'
---
## JS 逆向常用 HOOK 代码
