...
description: '一．文件命名规范 全局样式：global.css； 框架布局：layout.css； 字体样式：font.css； 链接样式：link.css； 打印样式：print.css； 二．常用类/ID命名规范 页 眉：header 内 容：con'
date: '2019-01-17 16:23:12'
updated: ''
category: '前端'
tags:
  - 'CSS'
...
hot: false
sourceId: 50
sourcePath: 'csswjmmgfhcylhidmmgf'
---
#### 一．文件命名规范
