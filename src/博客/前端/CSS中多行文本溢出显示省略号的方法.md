...
description: '适用范围重点： 因使用了WebKit的CSS扩展属性，该方法适用于WebKit浏览器及移动端； 使用方法： –webkitlineclamp 属性值为行数，用来限制在一个块元素显示的文本的行数。 为了实现该效果，它需要组合其他的WebKit'
