...
description: '一、HTML（用的elementui） ① 用@（von的缩写）绑定事件监听器 官方文档官方文档 ② :class 绑定 HTML 与 class ，也就是说，show 和 hide 这两个类是否被添加是根据 showText 和 hide'
date: '2018-11-26 16:04:11'
updated: ''
category: '前端'
tags:
  - 'Vue'
