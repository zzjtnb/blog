---
title: 'gulp 读取修改文件教程'
description: 'gulp 读取修改文件教程 一、安装 gulp gulp 官网http://www.gulpjs.com.cn/ gulp 的安装http://www.gulpjs.com.cn/docs/gettingstarted/ 核心点是 gulp'
date: '2021-08-21 11:48:33'
updated: ''
category: '前端'
tags:
  - 'Gulp'
