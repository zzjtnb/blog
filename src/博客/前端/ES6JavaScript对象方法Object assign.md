...
description: '1 基本用法 Object.assign 方法用于对象的合并，将源对象（ source ）的所有可枚举属性，复制到目标对象（ target ）。 Object.assign 方法的第一个参数是目标对象，后面的参数都是源对象。 注意，如果目标'
date: '2019-10-24 11:30:38'
updated: ''
category: '前端'
tags:
  - 'JavaScript'
...
hot: false
sourceId: 90
sourcePath: 'es6javascriptdxffobjectassign'
---
1   基本用法
