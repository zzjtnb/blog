...
description: 'JSON 中, 有两种结构: 对象和数组, 对象是没有 length 这个属性, 而数组结构是有的, 下面分别说下这两种结构之间的区别和遍历方式. 1. 对象 一个对象以 "{" 开始, "}"结束. 每个 "key" 后跟一 ":", "'
date: '2019-04-20 19:44:15'
updated: ''
category: '前端'
tags:
  - 'JavaScript'
...
hot: false
sourceId: 59
sourcePath: 'javascriptbljsondxsjdff'
---
