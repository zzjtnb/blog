...
description: '1.首先考虑使用闭包 结果为 0 1 这段代码可以如我们期望地那样工作，也很简单，然而还有一点不完美，函数体内再次用到了 getId 这个函数名，下次我们如果要改函数名，还需要改内部的名字了。 2.使用 JavaScript 世界里的一等公'
date: '2019-12-05 18:26:44'
updated: ''
category: '前端'
tags:
  - 'JavaScript'
