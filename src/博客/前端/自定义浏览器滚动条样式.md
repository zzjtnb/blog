---
title: '自定义浏览器滚动条样式'
description: '目前 webkit 支持拥有 overflow 属性的区域，列表框、下拉菜单、textarea 的滚动条自定义样式，所以用处还是很大的。 滚动条组成部分 了解了滚动条各个属性后，就可以开始设置样式，代码如下。 因为需求只需要符合主题配色，所'
date: '2021-11-19 20:48:56'
updated: ''
category: '前端'
tags:
  - 'CSS'
