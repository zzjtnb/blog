...
description: 'H5 项目常见问题及注意事项 Meta 基础知识： H5 页面窗口自动调整到设备宽度，并禁止用户缩放页面 空白页基本 meta 标签 其他 meta 标签 常见问题： 移动端如何定义字体 fontfamily 打电话发短信写邮件怎么实现 移'
date: '2018-12-25 18:29:10'
updated: ''
category: '前端'
tags:
  - 'HTML'
