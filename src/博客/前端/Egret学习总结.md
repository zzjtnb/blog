---
title: 'Egret学习总结'
description: '显示对象 egret.DisplayObject 显示对象容器 egret.DisplayObjectConatiner 事件 1.什么是事件？ 由用户或者系统触发了某些东西这个就叫事件。 1.1什么是事件监听器 发生事件之后我们要进行一些'
date: '2019-03-30 22:22:36'
updated: ''
category: '前端'
tags:
  - 'Egret'
