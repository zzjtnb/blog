---
title: '前端怎样操作网页的复制粘贴'
description: 'API 介绍: 复制、剪切、粘贴事件： 1. copy 发生复制操作时触发; 2. cut 发生剪切操作时触发; 3. paste 发生粘贴操作时触发; 4. 每个事件都有一个 before 事件对应：beforecopy、beforecu'
date: '2019-05-27 14:58:48'
updated: ''
category: '前端'
tags:
  - 'JavaScript'
