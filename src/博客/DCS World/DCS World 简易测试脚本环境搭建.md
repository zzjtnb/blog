---
title: 'DCS World 简易测试脚本环境搭建'
description: 'DCS World 简易测试脚本环境搭建 客户端环境 打开游戏界面选择任务编辑器, 之后新建一个任务, 然后游戏左边菜单点击设置触发器规则用来创建两条触发器规则 触发器包含三个选项: 触发 条件 动作 1. 设置第一条触发器 新建触发 新建'
date: '2021-10-23 00:42:08'
updated: '2021-11-01 04:17:03'
category: 'DCS World'
tags:
  - 'DCS World'
  - 'Lua'
...
hot: false
sourceId: 262
sourcePath: 'dcsworldjycsjbhjdj'
---
# DCS World 简易测试脚本环境搭建
