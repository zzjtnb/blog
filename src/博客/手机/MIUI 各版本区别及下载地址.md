...
description: '前言 此处仅介绍最常见的三个 MIUI 版本,其它由个人修改编译发布的 MIUI 将不在此篇文章中介绍. 一.Bootloader官方解锁工具 国外解锁工具https://en.miui.com/unlock/index.html 国内解锁'
date: '2022-07-09 03:45:42'
updated: '2022-07-09 03:56:07'
category: '手机'
tags:
  - 'MIUI'
...
```
## 相关链接
[MIUI本地化模块恢复](https://blog.minamigo.moe)
```html
