...
description: '解决问题： 我们经常使用 navicat 连接数据库，有时候时间久了之后，会忘记之前的密码，那么现在我们有办法获得只要正常连接的数据库的密码 步骤： 1. 导出连接 connections.ncx 打开navicat,点击文件导出连接,勾选'
date: '2021-04-23 23:15:39'
updated: '2021-05-27 18:32:51'
category: '数据库'
tags:
  - 'MySQL'
  - 'Navicat Premium'
...
hot: false
sourceId: 228
sourcePath: 'navicatpremiumyljsjkdmmnavicatckmmfa'
---
# 解决问题：
...
打开navicat,点击文件->导出连接,勾选**需要的数据库**和**导出密码**选项
