...
description: 'MariaDB 根据时间排序, 重新生成主键 表名:blogs 字段:id,path,title,sort,tags,img,content,hot,pageviews,created,updated 步骤如下: 1. 复制 blogs 结'
date: '2023-07-09 19:01:22'
updated: '2023-07-09 19:03:17'
category: '数据库'
tags:
  - 'MariaDB'
...
hot: false
sourceId: 289
sourcePath: 'mariadbgjsjpxzxsczj'
---
# MariaDB 根据时间排序, 重新生成主键
