...
description: '为您的新 Linux 发行版创建用户帐户和密码 使用适用于 Linux 的 Windows 子系统进行用户帐户和权限管理的参考. 在此中 1. 更新和升级包updateandupgradepackages 2. 发生你的 Linux 密码r'
date: '2021-07-02 07:32:04'
updated: ''
category: 'Windows'
tags:
  - 'Linux'
...
hot: false
sourceId: 250
sourcePath: 'wndxlinuxfxbcjyhzhhmm'
---
# 为您的新 Linux 发行版创建用户帐户和密码

> 使用适用于 Linux 的 Windows 子系统进行用户帐户和权限管理的参考.

### 在此中

1.  [更新和升级包](#update-and-upgrade-packages)
2.  [发生你的 Linux 密码](#reset-your-linux-password)
3.  [忘记密码](#forgot-your-password)
...
## [](#update-and-upgrade-packages)更新和升级包
...
## [](#reset-your-linux-password)发生你的 Linux 密码
