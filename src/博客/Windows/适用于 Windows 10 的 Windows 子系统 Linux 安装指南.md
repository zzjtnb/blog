...
description: '适用于 Windows 10 的 Windows 子系统 Linux 安装指南 在本文中 1. Windows 预览体验成员的简化安装simplifiedinstallationforwindowsinsiders 2. 手动安装步骤man'
date: '2021-07-02 07:23:11'
updated: '2021-07-02 07:41:46'
category: 'Windows'
tags:
  - 'Linux'
...
hot: false
sourceId: 249
sourcePath: 'syywindows10dwindowszxtlinuxazzn'
---
# 适用于 Windows 10 的 Windows 子系统 Linux 安装指南

### 在本文中

1.  [Windows 预览体验成员的简化安装](#simplified-installation-for-windows-insiders)
2.  [手动安装步骤](#manual-installation-steps)
3.  [步骤 1 - 为 Linux 启用 Windows 子系统](#step-1---enable-the-windows-subsystem-for-linux)
...
7.  [第 5 步 - 将 WSL 2 设置为默认版本](#step-5---set-wsl-2-as-your-default-version)
8.  [第 6 步 - 安装您选择的 Linux 发行版](#step-6---install-your-linux-distribution-of-choice)
9.  [安装 Windows 终端(可选)](#install-windows-terminal-optional)
10. [将您的分发版本设置为 WSL 1 或 WSL 2](#set-your-distribution-version-to-wsl-1-or-wsl-2)
11. [Troubleshooting installation](#troubleshooting-installation)

有两个选项可用于安装适用于 Linux 的 Windows 子系统 (WSL):

- **[简化安装](#simplified-installation-for-windows-insiders)** _(预览版)_:`wsl --install`
...
- **[手动安装](#manual-installation-steps)**:按照下面列出的六个步骤进行操作.

  下面列出了 WSL 的手动安装步骤,可用于在任何版本的 Windows 10 上安装 Linux.

笔记

如果您在安装过程中遇到问题,请查看本页底部的[安装疑难解答](#troubleshooting-installation)部分.

## [](#simplified-installation-for-windows-insiders)Windows 预览体验成员的简化安装
...
## [](#manual-installation-steps)手动安装步骤

如果您使用的不是 Windows Insiders 版本,则需要按照以下步骤手动启用 WSL 所需的功能.

## [](#step-1---enable-the-windows-subsystem-for-linux)步骤 1 - 为 Linux 启用 Windows 子系统
...
## [](#step-2---check-requirements-for-running-wsl-2)步骤 2 - 检查运行 WSL 2 的要求
...
## [](#step-3---enable-virtual-machine-feature)步骤 3 - 启用虚拟机功能
...
## [](#step-4---download-the-linux-kernel-update-package)步骤 4 - 下载 Linux 内核更新包
...
## [](#step-5---set-wsl-2-as-your-default-version)第 5 步 - 将 WSL 2 设置为默认版本
...
## [](#step-6---install-your-linux-distribution-of-choice)第 6 步 - 安装您选择的 Linux 发行版
...
## [](#install-windows-terminal-optional)安装窗口终端(任选)
...
![](https://docs.microsoft.com/en-us/windows/wsl/media/terminal.png)

## [](#set-your-distribution-version-to-wsl-1-or-wsl-2)将您的版本设置为 WSL 1 或 WSL 2
...
> 如果结果为无效命令 `wsl --set-default-version` ,请输入`wsl --help`.如果*命令*`--set-default-version` 未列出,则表示您的操作系统不支持它,您需要更新到 1903 版.Build 18362 或更高版本.如果您使用的是 ARM64 的 Build 19041,则在使用 PowerShell 时此命令可能会失败,在这种情况下,您可以使用来发出命令 `wsl.exe` .
...
## [](#troubleshooting-installation)安装疑难解答
...
- **安装失败,错误 0x80070003**
  ...
  - 打开**设置**->**系统**->**存储**->**更多存储设置:更改新内容的保存位置** ![](https://docs.microsoft.com/en-us/windows/wsl/media/appstorage.png)
...
![](https://docs.microsoft.com/en-us/windows/wsl/media/troubleshooting-virtualdisk-compress.png)
