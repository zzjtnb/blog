...
description: '在批处理文件中，往往我们想运行当前目录下的某些程序，比如说 bat 调用 java，请参看本人的其他文章。今天重点说怎么取得当前目录。 在度娘了很多文章之后做一个总结，目前，我发现的有两个： 很多人用第一种命令，但是有弊端。 第一种命令，是'
date: '2020-11-14 15:52:14'
updated: ''
category: 'Windows'
tags:
  - 'Batch'
...
hot: false
sourceId: 198
sourcePath: 'windowspclwjbatzdqml'
---
...
>路径1.1： C:\\Users\\Administrator
路径1.2： C:\\Users\\Administrator
路径1.3： D:\\classPath\\battojava
...
# npm 启动
+ 不存在node_modules就执行npm install 再执行npn run dev
+ 存在就直接执行npm run dev
```bat
@ECHO off 
SETLOCAL EnableDelayedExpansion 
