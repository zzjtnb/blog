...
description: '前言 虽然 WSL Win­dows Sub­sys­tem for Linux 可以直接访问 Win­dows 下的文件, 但是因为文件权限的问题, 把需要在 WSL 中使用的文件放在 WSL 的用户主目录是最好的解决方案没有之一. 为了'
date: '2021-07-07 09:01:34'
updated: ''
category: 'Windows'
tags:
  - 'LxRunOffline'
