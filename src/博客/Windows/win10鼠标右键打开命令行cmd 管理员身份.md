...
description: '添加到注册表 将下面命令保存为 reg 文件： 保存 文件名为 AddOpeninWindowsTerminalasAdministrator.reg 注意文件字符格式为 utf8 with bom或着GBK或GBK132 然后双击执行就可'
date: '2018-07-09 16:29:55'
updated: '2021-07-03 14:40:23'
category: 'Windows'
tags:
  - 'Windows 10'
...
hot: false
sourceId: 15
sourcePath: 'win10sbyjdkmlxcmdglysf'
---
# 添加到注册表
