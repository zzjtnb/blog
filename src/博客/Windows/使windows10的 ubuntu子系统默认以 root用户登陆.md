...
description: '一般子系统就是自己用,每次启动还要人工切到 root 权限,很是麻烦,如何让 Windows 的 WSL 子系统默认 root 登入呢? 1. 首先重置 root 密码 以普通用户登录系统 在终端输入命令: 创建 root 用户的密码 ,'
date: '2021-07-02 08:15:01'
updated: ''
category: 'Windows'
tags:
  - 'Linux'
...
hot: false
sourceId: 251
sourcePath: 'swindows10dubuntuzxtmryrootyhdl'
---
