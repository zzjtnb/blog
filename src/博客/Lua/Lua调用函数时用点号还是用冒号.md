...
description: '本文是面向对象预热篇，讲解函数两种调用方式的区别，初学者比较容易被坑。 1\. 初学者最易混乱 Top1——调用函数时用点号还是用冒号？ 我们来看看下面的两句代码： 对于初次接触 Lua 的朋友来说，这简直就是噩梦，为嘛函数的调用有两种形式'
date: '2020-11-16 04:50:30'
updated: ''
category: 'Lua'
tags:
  - 'Lua'
