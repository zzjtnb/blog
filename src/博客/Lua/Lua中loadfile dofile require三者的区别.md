...
description: '1.loadfile——只编译，不运行 loadfile 故名思议，它只会加载文件，编译代码，不会运行文件里的代码。 比如，我们有一个 hellofile.lua 文件： 这个文件里有一句代码，和一个函数。试试用 loadfile 加载这个'
date: '2020-11-16 04:42:27'
updated: ''
category: 'Lua'
tags:
  - 'Lua'
...
hot: false
sourceId: 202
sourcePath: 'luazloadfiledofilerequireszdob'
---
1.loadfile——只编译，不运行
-------------------
