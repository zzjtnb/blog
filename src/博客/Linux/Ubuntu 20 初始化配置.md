...
description: 'Ubuntu 20 初始化配置 一、初始化配置 1.更新系统 这里补充几个常用的清理命令： 命令描述apt autoclean将已删除软件包的. deb 安装文件从硬盘中删除apt clean同上，但会把已安装的软件包的安装包也删除掉apt'
date: '2020-09-02 21:32:11'
updated: ''
category: 'Linux'
tags:
  - 'Ubuntu'
...
grub界面美化[Grub-theme-vimix](https://www.gnome-look.org/p/1009236/)
...
![](https://i.loli.net/2020/07/11/fVjI3dwUWomGxA4.jpg)

这些 grub 主题大都有一键安装脚本，没有的话主题下载界面下方也有安装教程

*如果想换掉主题自带的背景图片，则需要转为 32 位色：*
```bash
...
```
**盘的名称不要有中文**
如果上面有的没有/media首先打开文件管理-其它位置-依次把其他盘符都点一遍
