---
title: 'v2ray卸载'
description: '使用脚本安装，然而没有卸载选项，那就自己动手吧 卸载 其中 systemd 和 sysv 二选一，取决于你的系统。 删除文件 Linux 服务端使用一键安装脚本安装后如何对软件进行完全卸载 参考：https://github.com/v2r'
date: '2020-04-05 12:46:04'
updated: ''
category: '软件'
tags:
  - 'V2Ray'
